...
const styles = (theme: ReturnType<typeof useTheme>) => ({
  ...
  title: { color: theme.colors.text, fontSize: 36, fontWeight: '900' as const, letterSpacing: -1, marginBottom: 24 },
  profileCard: { padding: 24, marginBottom: 32, alignItems: 'center' },
  ...
  statsRow: { flexDirection: 'row', backgroundColor: theme.colors.backgroundSecondary, borderRadius: theme.borderRadius.md, padding: 16, width: '100%', justifyContent: 'space-around', borderWidth: 1, borderColor: theme.colors.border },
  ...
  settingsCard: { padding: 0, overflow: 'hidden' as const, marginBottom: 32 },
  ...
  modalContent: { backgroundColor: theme.colors.surface, borderRadius: theme.borderRadius.xl, padding: 24, borderWidth: 1, borderColor: theme.colors.border },
  modalTitle: { color: theme.colors.text, fontSize: 20, fontWeight: '800' as const, marginBottom: 16, textAlign: 'center' },
  themeOption: { flexDirection: 'row', alignItems: 'center', padding: 16, gap: 16, borderRadius: theme.borderRadius.lg, borderWidth: 1, borderColor: 'transparent', marginBottom: 8 },
