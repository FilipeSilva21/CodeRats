...
const styles = (theme: ReturnType<typeof useTheme>) => ({
  ...
  title: { color: theme.colors.text, fontSize: 24, fontWeight: '900' as const, letterSpacing: -0.5, marginBottom: 12 },
  profileCard: { paddingHorizontal: 16, paddingVertical: 12, marginBottom: 16, alignItems: 'center', borderRadius: theme.borderRadius.md },
  profileHeader: { alignItems: 'center', marginBottom: 12 },
  avatarWrapper: { position: 'relative' as const, marginBottom: 12 },
  githubBadge: { position: 'absolute' as const, bottom: 0, right: 0, backgroundColor: '#24292e', width: 24, height: 24, borderRadius: 12, alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: theme.colors.surface },
  info: { alignItems: 'center' },
  name: { color: theme.colors.text, fontSize: 20, fontWeight: '800' as const, letterSpacing: -0.5, marginBottom: 2 },
  user: { color: theme.colors.textSecondary, fontSize: 13, fontWeight: '600' as const },
  statsRow: { flexDirection: 'row', backgroundColor: theme.colors.backgroundSecondary, borderRadius: theme.borderRadius.md, paddingHorizontal: 12, paddingVertical: 10, width: '100%', justifyContent: 'space-around', borderWidth: 1, borderColor: theme.colors.border },
  statItem: { alignItems: 'center' },
  statValue: { color: theme.colors.text, fontSize: 18, fontWeight: '800' as const },
  statLabel: { color: theme.colors.textSecondary, fontSize: 11, fontWeight: '600' as const, marginTop: 2 },
  statDivider: { width: 1, backgroundColor: theme.colors.border },
  sectionTitle: { color: theme.colors.text, fontSize: 16, fontWeight: '800' as const, marginBottom: 12 },
  settingsCard: { padding: 0, overflow: 'hidden' as const, marginBottom: 16, borderRadius: theme.borderRadius.md },
  settingRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 14, paddingVertical: 10 },
  settingLeft: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  settingIcon: { width: 32, height: 32, borderRadius: 8, alignItems: 'center', justifyContent: 'center' },
  settingText: { color: theme.colors.text, fontSize: 14, fontWeight: '600' as const },
  settingVal: { color: theme.colors.textSecondary, fontSize: 12, fontWeight: '500' as const },
  settingDivider: { height: 1, backgroundColor: theme.colors.border, marginLeft: 56 },
  actions: { marginTop: 'auto' },
  signOutBtn: { backgroundColor: 'rgba(239, 68, 68, 0.1)', borderColor: 'rgba(239, 68, 68, 0.2)' },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', paddingHorizontal: 20, paddingVertical: 16 },
  modalContent: { backgroundColor: theme.colors.surface, borderRadius: theme.borderRadius.lg, paddingHorizontal: 20, paddingVertical: 16, borderWidth: 1, borderColor: theme.colors.border },
  modalTitle: { color: theme.colors.text, fontSize: 18, fontWeight: '800' as const, marginBottom: 12, textAlign: 'center' },
  themeOption: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 14, paddingVertical: 10, gap: 10, borderRadius: theme.borderRadius.md, borderWidth: 1, borderColor: 'transparent', marginBottom: 6 },
  themeOptionActive: { borderColor: theme.colors.primary, backgroundColor: theme.colors.backgroundSecondary },
  themeOptionText: { color: theme.colors.text, fontSize: 14, fontWeight: '600' as const }
} as any);
