...
const styles = (theme: ReturnType<typeof useTheme>) => ({
  ...
  scroll: { paddingHorizontal: 20, paddingVertical: 16, gap: 16, paddingTop: 16 },
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  greeting: { color: theme.colors.textSecondary, fontSize: 16, fontWeight: '700' as const, marginBottom: 4 },
  name: { color: theme.colors.text, fontSize: 32, fontWeight: '900' as const, letterSpacing: -1 },
  ...
  mainCard: { padding: 0, overflow: 'hidden' as const, marginBottom: 12, borderRadius: 20 },
  mainCardInner: { paddingHorizontal: 20, paddingVertical: 18, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' as const },
  scoreLabel: { color: theme.colors.textSecondary, fontSize: 14, fontWeight: '800' as const, letterSpacing: 1.5, marginBottom: 8 },
  scoreVal: { color: theme.colors.text, fontSize: 46, fontWeight: '900' as const, letterSpacing: -2, lineHeight: 50 },
  streakBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: theme.colors.background, paddingHorizontal: 10, paddingVertical: 6, borderRadius: theme.borderRadius.full, gap: 6, borderWidth: 2, borderColor: theme.colors.border },
  streakText: { color: theme.colors.warning, fontWeight: '800' as const, fontSize: 14 },
  progressContainer: { paddingHorizontal: 20, paddingBottom: 18, gap: 10 },
  progressHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' as const },
  progressText: { color: theme.colors.textSecondary, fontSize: 14, fontWeight: '700' as const },
  progressValue: { color: theme.colors.text, fontSize: 15, fontWeight: '800' as const },
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 8 },
  section: { color: theme.colors.text, fontSize: 22, fontWeight: '900' as const, letterSpacing: -0.5 },
  seeAll: { color: theme.colors.accent, fontSize: 14, fontWeight: '800' as const },
  bar: { height: 8, backgroundColor: theme.colors.border, borderRadius: 4, overflow: 'hidden' as const },
  fill: { height: '100%', borderRadius: 4 },
  grid: { flexDirection: 'row', gap: 12 },
  stat: { flex: 1, alignItems: 'flex-start' as const, paddingHorizontal: 16, paddingVertical: 14, borderRadius: 16 },
  iconBox: { width: 36, height: 36, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  statVal: { color: theme.colors.text, fontSize: 24, fontWeight: '900' as const, letterSpacing: -0.5, marginBottom: 4 },
  statLabel: { color: theme.colors.textSecondary, fontSize: 12, fontWeight: '700' as const },
  activityList: { gap: 12 },
  activityRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14, backgroundColor: theme.colors.surface, borderRadius: 16, borderWidth: 2, borderColor: theme.colors.border },
  activityLeft: { flexDirection: 'row', alignItems: 'center', gap: 12, flex: 1, paddingRight: 12 },
  activityIconBox: { width: 36, height: 36, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  activityTitle: { color: theme.colors.text, fontSize: 16, fontWeight: '800' as const, marginBottom: 4 },
  activitySub: { color: theme.colors.textMuted, fontSize: 13, fontWeight: '600' as const },
  pointsPill: { backgroundColor: theme.colors.background, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 10, borderWidth: 2, borderColor: theme.colors.border },
  activityPoints: { color: theme.colors.text, fontSize: 14, fontWeight: '900' as const },
  emptyCard: { alignItems: 'center', justifyContent: 'center', padding: 24, gap: 12, borderStyle: 'dashed' as const },
