...
const styles = (theme: ReturnType<typeof useTheme>) => ({
  ...
  scroll: { padding: 24, gap: 24, paddingTop: 16 },
  ...
  mainCardInner: { padding: 24, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' as const },
  ...
  progressContainer: { paddingHorizontal: 24, paddingBottom: 24, gap: 12 },
  ...
  stat: { flex: 1, alignItems: 'flex-start' as const, padding: 20 },
  ...
  activityList: { gap: 12 },
  activityRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, backgroundColor: theme.colors.surface, borderRadius: theme.borderRadius.lg, borderWidth: 1, borderColor: theme.colors.border },
